...
sections:
  ...
  - block: features
    content:
      ...
      subtitle: 
      text: <span style="font-size:130%">이러한 분야에 관심이 있습니다</span><br>
      items:
        ...
        - name: <span style="font-size:110%; font-weight:bold">Algorithm</span>
          description: |
            <span style="font-size:120%; font-weight: 550">알고리즘을 이용한 보다 효율적인 서비스 설계</span>
          icon: gears
          icon_pack: fas
        - name: <span style="font-size:110%; font-weight:bold">Web</span>
          description: |
            <span style="font-size:120%; font-weight: 550">Node.js 등을 이용한 서버측과의 통신 설계 및 관리</span>
          icon: chrome
          icon_pack: fab
    design:
      spacing:
